import { contactInfo } from '../config/projects';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="w-8 h-8 rounded-lg overflow-hidden flex items-center justify-center bg-gradient-to-r from-blue-500 to-purple-600">
              ...
              <span className="text-xl font-bold text-gray-900 dark:text-white">BuildWithZar.</span>
            </div>
            <p className="text-gray-600 dark:text-gray-300 max-w-md">
            I build web applications with a focus on clean design and solid functionality. 
            I’m also passionate about learning and experimenting with Web3 and blockchain development.
            </p>
          </div>
